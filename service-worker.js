const CACHE_NAME = 'adp-kai-kalender-bali-v2-6-2';
const APP_SHELL = [
  './',
  './index.html?v=262&app=kd-bali-v262',
  './manifest-v262.webmanifest?v=262',
  ...
  './assets/icon-192-v144.png?v=262',
  './assets/icon-512-v144.png?v=262',
  './assets/favicon-48-v144.png?v=262',
  './assets/apple-touch-icon-v144.png?v=262'
];
...
self.addEventListener('fetch', event => {
  ...
  if (url.searchParams.get('v') === '262' || event.request.mode === 'navigate') {
