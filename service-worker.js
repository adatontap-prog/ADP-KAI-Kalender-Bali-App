const CACHE_NAME = 'adp-kai-kalender-bali-v2-6-10';
const APP_SHELL = [
  './',
  './index.html?v=270&app=kd-bali-v270',
  './manifest-v270.webmanifest?v=270',
  ...
  './assets/icon-192-v144.png?v=270',
  './assets/icon-512-v144.png?v=270',
  './assets/favicon-48-v144.png?v=270',
  './assets/apple-touch-icon-v144.png?v=270'
];
...
self.addEventListener('fetch', event => {
  ...
  if (url.searchParams.get('v') === '270' || event.request.mode === 'navigate') {
