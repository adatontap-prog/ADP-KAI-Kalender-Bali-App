const CACHE_NAME = 'adp-kai-kalender-bali-v2-6-11';
const APP_SHELL = [
  './',
  './index.html?v=271&app=kd-bali-v271',
  './manifest-v271.webmanifest?v=271',
  ...
  './assets/icon-192-v144.png?v=271',
  './assets/icon-512-v144.png?v=271',
  './assets/favicon-48-v144.png?v=271',
  './assets/apple-touch-icon-v144.png?v=271'
];
...
self.addEventListener('fetch', event => {
  ...
  if (url.searchParams.get('v') === '271' || event.request.mode === 'navigate') {
